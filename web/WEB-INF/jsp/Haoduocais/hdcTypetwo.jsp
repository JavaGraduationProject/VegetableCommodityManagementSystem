...
<div class="class">
  <ul style="list-style-type: none;text-align: center;">
    <li style="display: inline;background: red;margin-right: 30px;">所有分类1:</li>
    <c:forEach var="type" items="${requestScope.get('haoDuoCaiType')}">
      <li style="display: inline;margin-right: 30px;"><a style="text-decoration:none;" href="${pageContext.request.contextPath}/haoDuoCai/toHaoDuoCaiType/${type.getTname()}/${map.get("yrange")}">${type.getTname()}</a></li>
    </c:forEach>
    <li style="display: inline;background: red;margin-right: 30px;"><a href="${pageContext.request.contextPath}/haoDuoCai/toHaoDuoCaiTypeRank/${map.get("ytype")}/${map.get("yrange")}/ysale">销量排序</a></li>
<%--    <li style="display: inline;background: red;margin-right: 30px;"><a href="${pageContext.request.contextPath}/haoDuoCai/toHaoDuoCaiTypeRank/${map.get("ytype")}/${map.get("yrange")}/asc">价格升序</a></li>--%>
<%--    <li style="display: inline;background: red;margin-right: 30px;"><a href="${pageContext.request.contextPath}/haoDuoCai/toHaoDuoCaiTypeRank/${map.get("ytype")}/${map.get("yrange")}/desc">价格降序</a></li>--%>
  </ul>
</div>
